  ...
  const steps = [
    ...
    { key:'q5', type:'single', required:true,
      q:{vi:'Bạn mong muốn hình thức tư vấn nào?', en:'Which counseling format do you prefer?'},
      options:[
        {vi:'Online', en:'Online'},
        {vi:'Offline', en:'Offline'},
    ...
    { key:'q7', type:'multi', required:true,
    ...
    { key:'q8', type:'multi', required:false,
